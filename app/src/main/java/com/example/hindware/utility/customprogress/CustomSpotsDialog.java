...
public class CustomSpotsDialog extends AlertDialog {
    ...
    public static class Builder {
        ...
        public CustomSpotsDialog.Builder setContext(Context context) {
            this.context = context;
            return this;
        }

        public CustomSpotsDialog.Builder setMessage(String message) {
            this.message = message;
            return this;
        }

        public CustomSpotsDialog.Builder setMessage(@StringRes int messageId) {
            this.messageId = messageId;
            return this;
        }

        public CustomSpotsDialog.Builder setTheme(@StyleRes int themeId) {
            this.themeId = themeId;
            return this;
        }

        public CustomSpotsDialog.Builder setCancelable(boolean cancelable) {
            this.cancelable = cancelable;
            return this;
        }

        public CustomSpotsDialog.Builder setCancelListener(OnCancelListener cancelListener) {
            this.cancelListener = cancelListener;
            return this;
        }

        public AlertDialog build() {
            return new CustomSpotsDialog(
                    context,
    ...
    public CustomSpotsDialog(Context context, String message, int theme, boolean cancelable,
